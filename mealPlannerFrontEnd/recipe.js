...
function recipeCard(recipes) {
  recipes.forEach((recipe) => {
    ...
    seperateIngredients = allIngredients.split(",").join("\n");

    const eachIngredient = document.createElement("li");
    eachIngredient.id = "eachIngredient";
    eachIngredient.innerText = seperateIngredients;
    ...
    seperateInstructions = allInstructions.split(",").join("\n");

    const recipeInstructions = document.createElement("p");
    recipeInstructions.id = "instructions";
    recipeInstructions.innerText = seperateInstructions;
    ...
    editButton.addEventListener("click", (e) => {
      if (eachRecipeCard.contentEditable == "false") {
        ...
        editButton.addEventListener("click", (e) => {
          ...
          fetch(
            `https://meal-planner-back-end.herokuapp.com//recipes/${recipe.id}`,
            {
              method: "PATCH",
              headers: {
